        ...
        <div className="bg-gray-900 min-h-screen flex items-center justify-center">
            <div className="bg-gray-800 px-8 py-8 rounded-xl w-80 lg:w-96 shadow-lg transition-transform transform hover:scale-105">
                <div className="flex space-x-2 items-center mb-4">
                    ...
                    <h1 className='text-center text-white text-2xl font-bold'>Add Product</h1>
                </div>
                <div>
                    <input
                ...
                <div className='flex justify-center mb-3'>
                    <button
                        onClick={addProduct}
                        className='bg-blue-600 hover:bg-blue-700 transition duration-300 text-white font-bold px-4 py-2 rounded-lg shadow-md hover:shadow-lg'
                    >
                        Add Product
                    </button>
                </div>
